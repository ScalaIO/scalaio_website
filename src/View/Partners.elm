...
import Components.DataStruct as SponsorKind exposing (GlobalData)
import Components.Utils exposing (transform)
import Html exposing (Html, div, h1, text)
import Html.Attributes as Attr exposing (class)
import Components.DataStruct exposing (SponsorKind)



view:GlobalData ->  Html msg
view gd = div[Attr.class "flex  flex-col gap-y-20"][
