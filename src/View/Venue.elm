    ...
    div [ class "centered-body" ]
        ...
        , div [ class "venue-reach" ]
            ...
            , div [ class "venue-reach-instruction" ]
                ...
                ,  div[class "venue-reach-hotel-link"][img [ src ("/assets/icons/airbnb.svg"), class "icon-venue" ] [], a [href "https://www.airbnb.com/s/Paris/homes?tab_id=home_tab&refinement_paths%5B%5D=%2Fhomes&flexible_trip_lengths%5B%5D=one_week&price_filter_input_type=0&query=Paris&place_id=ChIJD7fiBh9u5kcRYJSMaMOCCwQ&date_picker_type=calendar&checkin=2022-11-03&checkout=2022-11-04&adults=1&source=structured_search_input_header&search_type=autocomplete_click", target "_blank"
                ][text "Access to pre setup link on Air-bnb"]]
                ,  div[class "venue-reach-hotel-link"][img [ src ("/assets/icons/booking.svg"), class "icon-venue" ] [], a [href "https://www.booking.com/searchresults.fr.html?label=msn-APBgIvrZ0FSl3i_Ja_RdBg-80470634554589%3Atikwd-16659123052%3Aloc-66%3Anes%3Amte%3Alp127187%3Adec%3Aqsreservation+hotel&sid=2ce13fa2392ff8d5a7742054d77884aa&aid=393655&lang=fr&sb_lp=1&src=index&error_url=https%3A%2F%2Fwww.booking.com%2Findex.fr.html%3Faid%3D393655%26label%3Dmsn-APBgIvrZ0FSl3i_Ja_RdBg-80470634554589%253Atikwd-16659123052%253Aloc-66%253Anes%253Amte%253Alp127187%253Adec%253Aqsreservation%2520hotel%26sid%3D2ce13fa2392ff8d5a7742054d77884aa%26sb_price_type%3Dtotal%26%26&ss=Paris%2C+%C3%8Ele-de-France%2C+France&is_ski_area=&checkin_year=2022&checkin_month=11&checkin_monthday=3&checkout_year=2022&checkout_month=11&checkout_monthday=4&group_adults=1&group_children=0&no_rooms=1&b_h4u_keep_filters=&from_sf=1&ss_raw=Paris&ac_position=0&ac_langcode=fr&ac_click_type=b&dest_id=-1456928&dest_type=city&iata=PAR&place_id_lat=48.85668&place_id_lon=2.351476&search_pageview_id=3cfb982781e500e7&search_pageview_id=3cfb982781e500e7&search_selected=true&ac_suggestion_list_length=5&ac_suggestion_theme_list_length=0&nflt=pri%3D2%3Bpri%3D1", target "_blank"
                ][text "Access to pre setup link on Booking.com"]]
                ,  div[class "venue-reach-hotel-link"][img [ src ("/assets/icons/hotelscom.svg"), class "icon-venue" ] [], a [href "https://fr.hotels.com/Hotel-Search?adults=1&d1=2022-11-03&d2=2022-11-04&destination=Paris%2C%20France&endDate=2022-11-04&latLong=48.856696%2C2.351761&regionId=2734&selected=&semdtl=&sort=RECOMMENDED&startDate=2022-11-03&theme=&useRewards=false&userIntent=", target "_blank"
