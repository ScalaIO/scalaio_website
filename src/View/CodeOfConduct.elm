...
view =
    div [ class "coc" ]
        ...
        , p [] [ text "Scala.IO is an all-ages event for people from many different backgrounds. We expect presenters, exhibitors, and attendees to help make scala.io enjoyable for everyone, regardless of age, gender, sexuality, religious or ethnic identity, or ability." ]
        ...
        , ul [class "list"]
            ...
            , li [] [ text "There are many parties associated with scala.io, and these guidelines apply equally there. Please consume alcohol responsibly." ]
        ...
        , p [] [ text "Scala.io is an all-ages, mixed-gender event. Please make sure your booth and party can be enjoyed by everyone. In particular, overtly sexualized booths or parties, including \"booth babes\" or hired entertainers in provocative/sexy attire, are not appropriate." ]
