...
head static =
    Seo.summary
        ...
        , siteName = "elm-pages"
        , image =
            { url = Pages.Url.external "ScalaIO Schedule"
            , alt = "elm-pages logo"
            , dimensions = Nothing
            , mimeType = Nothing
            }
        ...
        , locale = Nothing
        , title = "ScalaIO - Schedule" -- metadata.title -- TODO
        }
        |> Seo.website
...
view maybeUrl sharedModel static =
    { title = "ScalaIO - Schedule"
    , body = globalPageStructure static.data (View.Schedule.view static.data)
    }
